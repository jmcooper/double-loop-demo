...
describe('users api controller', function() {
  ...
  describe('users api controller', function() {
    ...
    describe('get', function() {
      var result
      var userFromRepository = {id: 'abc', first_name: 'Jane', last_name: 'Smith'}
      ...
      beforeEach(function(done) {
        ...
        usersController.get('123-abc').then(function(response) { result = response; done() })
      ...
      it('should map the firstName', function() {
        expect(result.firstName).toEqual(userFromRepository.first_name)
      })
      it('should map the lastName', function() {
        expect(result.lastName).toEqual(userFromRepository.last_name)
      })
    })
  })
})
